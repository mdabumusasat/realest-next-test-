        ...
        <div className="inner-container">
          <div className="main-box">
            <div className="left-box">
              <div className="logo-box">
                <div className="logo one">
                  <Link href="/"><img src="/assets/images/logo3.png" alt="Logo" /></Link>
                </div>
                <div className="logo two">
                  <Link href="/"><img src="/assets/images/logo2.png" alt="Logo" /></Link>
                </div>
              </div>
            ...
            <div className="right-box">
              <Link className="theme-btn btn-style-four" href="/page-about">
                <span className="icon">
              ...
              <button className="mobile-nav-toggler" onClick={handleOpen}>
                <span></span>
                <span></span>
                <span></span>
              </button>

...
import ProgressBar5 from '../../components/elements/ProgressBar2';
          ...
          <div className="col-lg-8">
            <form
              ...
              <div className="mb-3 text-center">
                ...
                <button
                  type="reset"
                  className="theme-btn btn-style-five ms-2">

...
const images = [
  "/assets/images/resource/products/product-details.jpg",
  "/assets/images/resource/products/product-details2.jpg",
  "/assets/images/resource/products/product-details3.jpg",
];
    ...
    <section className="product-details pt-120">
      ...
      <div className="product-details__buttons">
        <div className="product-details__buttons-1">
          <Link href="/shop-cart" className="theme-btn btn-style-five">Add to Cart</Link>
        </div>
        <div className="product-details__buttons-2">
          <Link href="/shop-product-details" className="theme-btn btn-style-five">Add to Wishlist</Link>
        </div>
      </div>
      <div className="product-details__social">
        <div className="title mt-10">
          <div className="h3">Share with friends</div>
        </div>
                      ...
                      <div className="single-comment-box">
                        <div className="inner-box">
                          ...
                          <div className="inner">
                            ...
                            <h5>Jon D. William, <span>05 May, 2026 . 4:00 pm</span></h5>
                      ...
                      <div className="single-comment-box">
                        <div className="inner-box">
                          ...
                          <div className="inner">
                            ...
                            <h5>Aleesha Brown, <span>05 May, 2026 . 8:00 pm</span></h5>
                            <p>Aliquam hendrerit a augue insuscipit. Etiam aliquam massa quis des mauris commodo.</p>
                          </div>
                        </div>
                      </div>
